...
namespace App2.RabbitMq
{
    public class SubscriberService : BackgroundService
    {
        ...
        public SubscriberService(IServiceProvider sp, IConfiguration configuration)
        {
            ...
            //    autoDelete: false,
            //    arguments: null);
            _channel.QueueDeclare(queue: _configuration["RabbitMq:App2Queue"], durable: false, exclusive: false, autoDelete: false, arguments: null);
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(queue: _configuration["RabbitMq:App2Queue"], autoAck: true, consumer: consumer);
